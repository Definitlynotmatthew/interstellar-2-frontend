...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/interstellar-2-frontend)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/interstellar-2-frontend
```

A live public deployment of this template is available at [https://interstellar-2-frontend.templates.workers.dev](https://interstellar-2-frontend.templates.workers.dev)
